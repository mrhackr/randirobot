...
PM_START_TEXT = """
Hi {}, my name is {}!
// I am an Powerfull  group management bot with a lot of Special Features.
You can find the list of available commands with /help.
==========================
-> My Creator CeoWhiteHatCracks(https://t.me/ceowhitehatcracks)
-> Report [Sensible Group Management](https://t.me/sensiblegroupmanagement) if I go offline
==========================
...
Our bot is hosted on heroku PL LARGE Dynos. \
You Can Donate by joining @WhiteHatCracks
We Donot Take ANy Kind Of money Etc Thanks For Donating If You join."""
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="👥 Add CeoGroupHelpbot to your group", url="https://t.me/ceogroupehelpbot?startgroup=new")],
                 [InlineKeyboardButton(text="🙋 Support Group", url="https://t.me/sensiblegroupmanagement"), InlineKeyboardButton(text="🚫 Global Logs", url="https://t.me/ceogroupehelpbot_globallogs")],
