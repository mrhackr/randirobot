...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text("Initiating Global Ban Of User")
    ...
    log_message = (f"#GBANNED\n"
                   ...
                   f"<b>Sudo:</b> {mention_html(user.id, user.first_name)}\n"
                   f"<b>Banned User:</b> {mention_html(user_chat.id, user_chat.first_name)}\n"
                   f"<b>Banned User ID:</b> {user_chat.id}\n"
                   f"<b>Time Of Ban:</b> {current_time}\n You Can Appeal Ungban Or Global Bans at @CeoGroupHelpbot_Gbanregress")
